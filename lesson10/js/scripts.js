...
if(jsObject.main.temp < 50 && jsObject.wind.speed > 3) {
  ...
  /*----------------------5 DAY FORCAST API------------------------*/
  const apiURL2 = "https://api.openweathermap.org/data/2.5/forecast?id=5604473&units=imperial&appid=9d82d746ab9b4a97a81f74aae8a3582b";
fetch(apiURL2)
  .then(response => response.json())
  .then(jsObject => {
    //   console.log(jsObject);

    //string.includes(18:00:00) Method ... or sting.indexof()
